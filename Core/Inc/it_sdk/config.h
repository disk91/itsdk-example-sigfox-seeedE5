...
#define ITSDK_WITH_UART				( __UART_USART2 |  __UART_LPUART1 )		// Use LPUART1 and USART2 for debug USART1 possible ( can't mix LPUART1 with USART1 )
...
#define ITSDK_WITH_SPI				(__SPI_ENABLED | __SPI_SUBGHZ)			// Use SPI (includes the structures, bit field for the different type of SPI)
...
#define ITSDK_LOGGER_CONF			0x00F0									// error->info level on serial2 => USART2 + 1 (see logger.c)
...
#define ITSDK_LOWPOWER_GPIO_A_KEEP	(  __LP_GPIO_NONE \
								/*	 | __LP_GPIO_0  */ /* GPIO (P23 on E5) */\
								/*	 | __LP_GPIO_1  */ \
								/*	 | __LP_GPIO_2  */ /* USART2 - TX (UART on dev board) (P19 on E5) */ \
								/*	 | __LP_GPIO_3  */ /* USART2 - RX (UART on dev board) (P18 on E5) */ \
								/*	 | __LP_GPIO_4	*/ /* RFO Cnf1 */ \
								/*	 | __LP_GPIO_5	*/ /* RFO Cnf2 */ \
								/*	 | __LP_GPIO_6	*/ \
								/*	 | __LP_GPIO_7	*/ \
								/*	 | __LP_GPIO_8	*/ \
								/*	 | __LP_GPIO_9	*/ /* GPIO (P21 on E5) */\
								/*	 | __LP_GPIO_10	*/ /* SPI2_MISO (P27 on E5) */\
								/*	 | __LP_GPIO_11	*/ \
								/*	 | __LP_GPIO_12	*/ \
								/*	 | __LP_GPIO_13	*/ /* SWDIO */\
								/*	 | __LP_GPIO_14	*/ /* SWDCLK */\
								/*	 | __LP_GPIO_15	*/ /* I2C SDA */\
...
#define ITSDK_LOWPOWER_GPIO_B_KEEP	(  __LP_GPIO_NONE \
								...
								/*	 | __LP_GPIO_3 */ /* GPIO */\
								/*	 | __LP_GPIO_4 */ /* GPIO */\
									 | __LP_GPIO_5 /* GPIO (LED D5 on dev board) (P11 on E5)*/\
								/*	 | __LP_GPIO_6 */ /* USART1 - TX (USB on dev board) */ \
								/*	 | __LP_GPIO_7 */ /* USART1 - RX (USB on dev board) */ \
								/*	 | __LP_GPIO_8 */ \
								/*	 | __LP_GPIO_9 */ /* SPI2_NSS (P25 on E5)*/\
								/*	 | __LP_GPIO_10	*/ /* GPIO ( P20 on E5 ) */ \
								/*	 | __LP_GPIO_11	*/ \
								/*	 | __LP_GPIO_12 */ \
								/*	 | __LP_GPIO_13 */ /* SPI2_SCK & ( Button BOOT on dev board ) (P24 on E5)*/\
								/*	 | __LP_GPIO_14 */ /* SPI2_MISO (P26 on E5) */\
								/*	 | __LP_GPIO_15 */ /* I2C SCL */\
									)										// Keep activ (led 1,3,4), radio, button, spi2, sx1276 GPIO 0,1,2
#define ITSDK_LOWPOWER_GPIO_C_KEEP	(  __LP_GPIO_NONE  \
									  | __LP_GPIO_0  /* LPUART_RX / GPIO (LPUART on dev board) (P13 on E5)*/ \
									  | __LP_GPIO_1  /* LPUART_TX / GPIO (LPUART on dev board) (P12 on E5)*/ \
								/*	  | __LP_GPIO_2 */  \
								/*	  | __LP_GPIO_13 */ \
